...
namespace denem2
{
    public partial class HidrolikOransal : Form
    {
        ...
        private void btnPresHidStart_Click(object sender, EventArgs e)
        {
            if (lblSifre.Text == "2946")
            {
                ...
                string tag = read_Tag(AlltagClass.ALLTagList[568]);
                Debug.WriteLine("Ayar değeri şuuuuu : "+tag);
                if (tag == "True")
                {
                    writePLC(AlltagClass.ALLTagList[568], false, 1);
                }
                else
                {
                    writePLC(AlltagClass.ALLTagList[568], true, 1);
                }
        ...
        {
            writePLC(AlltagClass.ALLTagList[562], true, 1);
        }

        private void btnp2adim_Click(object sender, EventArgs e)
        {
            writePLC(AlltagClass.ALLTagList[563], true, 1);
        }

        private void btnp3adim_Click(object sender, EventArgs e)
        {
            writePLC(AlltagClass.ALLTagList[564], true, 1);
        }

        private void lblPresPKatsayi_Click(object sender, EventArgs e)
        {
            if (S7.GetBitAt(Db4Kalip, 40, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[548], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        private void lblPresPsifirVal_Click(object sender, EventArgs e)
        {
            if (S7.GetBitAt(Db4Kalip, 40, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[546], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        private void lblPresPYuzVal_Click(object sender, EventArgs e)
        {
            if (S7.GetBitAt(Db4Kalip, 40, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[547], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        {
            if (S7.GetBitAt(Db4Kalip, 41, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[552], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        private void lblPresQsifirVal_Click(object sender, EventArgs e)
        {
            if (S7.GetBitAt(Db4Kalip, 41, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[550], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        private void lblPresQYuzVal_Click(object sender, EventArgs e)
        {
            if (S7.GetBitAt(Db4Kalip, 41, 6))
            {
                Form f = new Calculator(AlltagClass.ALLTagList[551], 1, 9999, 0);
                f.ShowDialog(this);
            }
        }
        ...
        {
            writePLC(AlltagClass.ALLTagList[569], true, 1);
        }

        private void btnQ2adim_Click(object sender, EventArgs e)
        {
            writePLC(AlltagClass.ALLTagList[570], true, 1);
        }

        private void btnQ3adim_Click(object sender, EventArgs e)
        {
            writePLC(AlltagClass.ALLTagList[571], true, 1);
        }
        ...
        private void btnPresQayarla_Click(object sender, EventArgs e)
        {
            if (lblSifre.Text == "2946")
            {
                ...
                string tag = read_Tag(AlltagClass.ALLTagList[575]);
           
                if (tag == "True")
                {
                    writePLC(AlltagClass.ALLTagList[575], false, 1);
                }
                else
                {
                    writePLC(AlltagClass.ALLTagList[575], true, 1);
                }
                writePLC(AlltagClass.ALLTagList[442], true, 0);
            }
        }
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                if (Result == 0 && Client.Connected)
                {
                    ...
                    Result = Client.ReadArea(S7Consts.S7AreaDB, 4, 460, 44, S7Consts.S7WLByte, Db4Kalip);
                    ShowResult(Result);
        ...
        private void HidrolikOransal_Activated(object sender, EventArgs e)
        {
            if (!timer1.Enabled)
                timer1.Enabled = true;
        }

        private void HidrolikOransal_Deactivate(object sender, EventArgs e)
        {
            if (timer1.Enabled)
                timer1.Enabled = false;
        }

        private void HidrolikOransal_Load(object sender, EventArgs e)
        {
            CPUbaglan();
        }
